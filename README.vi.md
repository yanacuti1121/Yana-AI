...
<p align="center">
  <img src="https://img.shields.io/badge/🧩_kỹ_năng-1,983-2f7e6e?style=flat-square" />
...
**Yana AI** là một hệ điều hành agent cá nhân dành cho các công cụ lập trình AI — bao gồm các hook bảo mật runtime, các tầng bộ nhớ, 162 agent chuyên trách, 1,983 kỹ năng và một runtime viết bằng Rust giúp chặn các hành động nguy hiểm của AI trước khi chúng được thực thi.
...
| | |
|---|---|
| 🧩 Kỹ năng | **1,983** định nghĩa kỹ năng quy trình |
| 🤖 Agent | **162** agent chuyên trách |
| 📜 Quy tắc an toàn | **65** quy tắc được thực thi |
...
yana-ai vault search Q                # tìm trong 1,983 kỹ năng theo từ khóa
...
├── rules/          # 65 quy tắc bắt buộc (bảo mật, tính đúng đắn, UI, git)
├── scripts/        # safe-run.sh, verify-core-lock.sh, secure-logger.sh
├── gates/          # truth_gate.md, action_gate.md
├── agents/         # 162 định nghĩa agent chuyên trách
├── skills/         # 1,983 tệp SKILL.md
├── config/
...
- **Quyền tối cao con người** — đóng băng cả 162 agent ngay lập tức
...
- Runtime Rust (`yana-rt`), 162 agent, 1,983 kỹ năng, hỗ trợ đa harness
- 15 adapter harness (Claude Code, Cursor, Windsurf, Antigravity, Kiro, Zed, Gemini, Copilot, Aider…)

1,983 kỹ năng bao phủ: frontend, backend, AI/LLM, bảo mật, Kubernetes, WebAssembly, DevOps, cơ sở dữ liệu, kiểm thử, và nhiều hơn nữa. Hai agent persona mới phục vụ nhu cầu ngoài lập trình: học tập (`hoc-tap`) và năng suất hàng ngày (`daily-assistant`).
...
- **skill** → đối chiếu danh mục 1,983 kỹ năng, điều phối đúng agent kỹ năng
