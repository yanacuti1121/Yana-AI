...
**Yana AI** là một hệ điều hành agent cá nhân dành cho các công cụ lập trình AI — bao gồm các hook bảo mật runtime, các tầng bộ nhớ, 97 agent chuyên trách, 1,983 kỹ năng và một runtime viết bằng Rust giúp chặn các hành động nguy hiểm của AI trước khi chúng được thực thi.
...
- Runtime Rust (`yana-rt`), 97 agent, 1,983 kỹ năng, hỗ trợ đa harness
