...
| [Goose](https://github.com/aaif-goose/goose) | Provider-agnostic, đa provider, đa extension (MCP) — gần nhất với provider plane của Yana | Trước hết là một agent runtime mạnh; approval thực thi và scoping capability không phải nguyên tắc tổ chức của họ như thẩm quyền là của Yana |
