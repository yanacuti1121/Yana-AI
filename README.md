...
├── config/
│   ├── core-lock.json    # SHA-256 manifest — 285 core files pinned
...
|---|---|---|
| Product (rules/hooks/skills/agents/CLI) | **1.4.6** | None — not distributed via npm, see [VERSIONING.md](VERSIONING.md#why-product-has-no-registry) |
