...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/📜_rules-67-b96b80?style=flat-square" />
  <img src="https://img.shields.io/badge/🪝_hooks-50-b78f3d?style=flat-square" />
...
| 🪝 Hooks | **50** pre/post-execution hooks |
| ⚡ Slash commands | **166** |
...
```
core/
├── hooks/          # 50 PreToolUse / PostToolUse / Stop hooks
├── rules/          # 67 enforced rules (security, correctness, UI, git)
