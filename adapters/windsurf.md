# YAMTAM ENGINE — Windsurf Adapter
# Version: 1.8.0
# Covers: Windsurf (Codeium) — Cascade agent, all versions
#
# How to apply:
#   Option A — workspace rules (recommended):
#     bash core/scripts/switch-engine.sh windsurf
#     → generates .windsurf/rules/yamtam.md (read by Cascade automatically)
#   Option B — legacy single file:
#     Copy this content into .windsurfrules at your project root.
