# YAMTAM ENGINE — Kiro Adapter
# Version: 1.8.0
# Covers: Kiro IDE & Kiro CLI (AWS) — steering system
#
# How to apply:
#   Option A — steering file (recommended):
#     bash core/scripts/switch-engine.sh kiro
#     → generates .kiro/steering/yamtam.md (always-included steering)
#   Option B — AGENTS.md standard:
#     Kiro reads AGENTS.md at the workspace root automatically.
