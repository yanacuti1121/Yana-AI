---
name: openai--twilio-developer-kit--twilio-agent-augmentation-architect
description: >-
  >
origin: "openai/plugins — twilio-developer-kit/twilio-agent-augmentation-architect (MIT)"
license: MIT
version: "0.1.0"
