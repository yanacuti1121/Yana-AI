"""Retry utilities — jittered backoff for decorrelated retries — verbatim port.

Origin:  NousResearch/hermes-agent @ 5378b941209d8f62a65455041658ce8ce8144cc9
         agent/retry_utils.py (MIT License)
Ported:  2026-06-25. Self-contained stdlib-only module — ported unchanged.
