...
| Dependency Vulnerability Audit (`ci.yml`) | A8 | T1 FAST | **REQUIRED FOR MERGE** | Added this workstream (B1); currently RED by design (real unpatched `quinn-proto`/`pytest` CVEs) — see B1 audit |
