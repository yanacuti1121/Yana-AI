# YAMTAM ENGINE — Social Media Posts
...
**Title:**
```
Show HN: YAMTAM ENGINE – Safety hooks for Claude Code (blocks rm -rf, prompt injection, pipe-to-shell)
```
...
It sits outside your product repos and intercepts AI actions before they cause damage:
  ...
  You → Claude Code → [YAMTAM HOOKS] → executes (or gets blocked)
...
I've been building YAMTAM ENGINE — a personal agent OS that wraps Claude Code with runtime safety enforcement. 17 years old, built this because I was worried about AI coding tools doing dangerous things without asking.
...
Apache 2.0: https://github.com/phamlongh230-lgtm/yamtam-engine
...
These happened. YAMTAM blocks the patterns.
```
...
→ github.com/phamlongh230-lgtm/yamtam-engine
