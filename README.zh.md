...
**[在线体验 →](https://yanai-production.up.railway.app)** · **[下载桌面版 →](https://yana.vutam.link/desktop.html)** · **[命令参考 →](https://yanacuti1121.github.io/Yana-AI/commands.html)** · **[最新版本 →](https://github.com/yanacuti1121/Yana-AI/releases/latest)**
...
- SSE 流式传输，移动端友好 · **[Electron 桌面应用](https://yana.vutam.link/desktop.html)** — macOS、Windows、Linux
