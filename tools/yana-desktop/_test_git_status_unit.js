...
const sample = [
  ...
  '2 R. N... 100644 100644 100644 h h src/c.rs\tsrc/old.rs',
  '? new-file.txt',
  '',
].join('\n');
...
check('empty output: branch null, counts zero', empty.branch === null && empty.modifiedCount === 0 && empty.untrackedCount === 0);
...
console.log('git-status unit tests passed: 9');
