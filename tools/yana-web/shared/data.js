...
window.YANA = {
  ...
  providers: [
    ...
    { id: "glm",        name: "GLM",        company: "Zhipu AI",   models: ["GLM-4", "GLM-4 Flash", "GLM-4V"],      role: "Vision-capable — GLM-4V reads images" },
    { id: "kimi",       name: "Kimi",       company: "Moonshot AI", models: ["Moonshot v1 8K", "32K", "128K"],      role: "Long context — up to 128K tokens" },
    { id: "xai",        name: "xAI",        company: "xAI",        models: ["Grok 3", "Grok 3 Mini", "Grok 2 Vision"], role: "Vision-capable — Grok 2 Vision reads images" },
    { id: "novita",     name: "Novita",     company: "Novita AI",  models: ["Llama 3.1 70B", "Llama 3.1 8B"],       role: "Hosted open-weight models" },
    { id: "nvidia",     name: "NVIDIA",     company: "NVIDIA",     models: ["Nemotron 70B", "Llama 3.3 70B", "Nemotron Super 49B"], role: "NVIDIA-hosted open models" },
    { id: "minimax",    name: "MiniMax",    company: "MiniMax",    models: ["abab6.5s", "abab6.5g"],                role: "Chinese frontier model" },
    { id: "huggingface", name: "Hugging Face", company: "Hugging Face", models: ["Llama 3.3 70B", "Qwen2.5 72B", "Mistral 7B"], role: "Inference API — open-weight model hub" },
