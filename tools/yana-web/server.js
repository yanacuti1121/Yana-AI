...
// Robot voice/MCP bridge shares this same server instance via the
// 'upgrade' event — Railway forwards exactly one port to one process
// (railway.toml), so a second listener would not be reachable.
robot.attach(server);
