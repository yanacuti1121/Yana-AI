...
import { SkillPicker } from './html-maker/skill-picker.jsx';
  ...
  return (
    <div data-screen-label="HTML Maker" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--gap)', height: '100%', minHeight: 0 }}>
      ...
      <div style={{ display: 'flex', gap: 'var(--gap)', flex: 1, minHeight: 0, overflow: 'hidden' }}>
        ...
        {/* ── Left: skill picker ── */}
        <SkillPicker groups={groups} search={search} setSearch={setSearch} selectedSkill={selectedSkill} setSelectedSkill={setSelectedSkill} />
