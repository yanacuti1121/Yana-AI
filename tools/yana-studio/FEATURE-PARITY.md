...
Updated: 2026-09-07. Source requirements: the user-provided legacy Yana Desktop
...
| Tasks & process            | Child chat and terminal lifecycle management                                                                                                                                     | Shared CLI task store, task CRUD, task/evidence/activity correlation                                                                                     |
...
## Discrete backlog (28 remaining capabilities)
...
ZIP inspection; safe extract/create; human Git stage/unstage/commit UI; task CRUD;
task/evidence correlation; permission leases; HALT and
